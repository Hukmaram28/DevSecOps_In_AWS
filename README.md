...
We use Helm charts to install Falco in the cluster as a daemon set, alongside Fluent Bit. Additionally, an AWS CloudWatch log group is created to store all alerts.
